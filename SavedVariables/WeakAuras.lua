...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["[T]Bones"] = {
			["outline"] = "OUTLINE",
			["fontSize"] = 18,
			["xOffset"] = 201.554626464844,
			["displayText"] = "%p",
			["yOffset"] = -104.913543701172,
			["regionType"] = "text",
			["activeTriggerMode"] = 0,
			["customTextUpdate"] = "update",
			["actions"] = {
	...
	["frame"] = {
		["xOffset"] = 27.6549072265625,
		["yOffset"] = -89.4320678710938,
		["height"] = 492,
