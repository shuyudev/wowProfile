...
Postal3DB = {
	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				"Darknex|Emerald Dream|Horde|108|ROGUE", -- [1]
				"Därknex|Kel'Thuzad|Alliance|1|HUNTER", -- [2]
				"Eavey|Emerald Dream|Horde|1|HUNTER", -- [3]
				"Elunex|Malygos|Alliance|100|DRUID", -- [4]
				"Elunnex|Emerald Dream|Horde|1|DRUID", -- [5]
				"Felnex|Emerald Dream|Horde|100|DEMONHUNTER", -- [6]
				"Gorlordis|Emerald Dream|Horde|1|MONK", -- [7]
				"Marnethy|Emerald Dream|Horde|1|MONK", -- [8]
				"Neroix|Emerald Dream|Horde|2|PRIEST", -- [9]
				"Ruthala|Emerald Dream|Horde|1|MONK", -- [10]
				"Shadowzxz|Emerald Dream|Horde|1|WARLOCK", -- [11]
				"Shädowx|Emerald Dream|Horde|1|PRIEST", -- [12]
			},
		},
	},
	["profiles"] = {
